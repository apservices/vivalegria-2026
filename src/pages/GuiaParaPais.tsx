  ...
  const developmentTopics = [
    {
      ...
      description:
        "O brincar estruturado estimula o raciocínio lógico, resolução de problemas e criatividade. Atividades guiadas desenvolvem habilidades essenciais para o aprendizado.",
    },
    {
      icon: Heart,
      title: "Inteligência Emocional",
      description:
        "Brincadeiras em grupo ensinam empatia, cooperação e gestão de emoções. Monitores treinados facilitam interações positivas e construtivas.",
    },
    {
      icon: Palette,
      title: "Expressão Criativa",
      description:
        "Oficinas artísticas permitem que crianças expressem sentimentos e ideias de forma única, fortalecendo autoestima e identidade.",
    },
  ];
  ...
  const creativityTopics = [
    {
      ...
      description:
        "Atividades artísticas desenvolvem coordenação motora fina, concentração e autoconfiança. Cada obra é uma conquista pessoal.",
    },
    {
      icon: Lightbulb,
      title: "Oficinas Educativas",
      description:
        "Slime ensina química básica, jardinagem conecta com a natureza, pintura explora cores e formas. Aprender brincando é mais eficaz.",
    },
  ];
  ...
  const trendingIdeas = [
    {
      ...
      description:
        "Decoração eco-friendly, oficinas de reciclagem criativa e jogos que ensinam sobre meio ambiente",
    },
    {
      title: "Experiências Sensoriais",
      description:
        "Massinha caseira, slime texturizado e pintura com diferentes materiais para estimular todos os sentidos",
    },
    {
