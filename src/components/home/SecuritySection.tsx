...
const securityPoints = [
  {
    ...
    description: "Todos os recreadores passam por treinamento intensivo e possuem experiência comprovada com crianças.",
  },
  {
    icon: Shield,
    title: "Protocolos de Segurança",
    description: "Seguimos protocolos rigorosos de higiene e segurança em todos os eventos.",
  },
  {
    icon: HeartHandshake,
    title: "Acompanhamento Próximo",
    description: "Proporção de 1 monitor para cada 15 crianças, garantindo atenção individualizada.",
  },
  {
    icon: Award,
    title: "Materiais Premium",
    description: "Utilizamos apenas materiais atóxicos e seguros, adequados para cada faixa etária.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div>
            <div className="inline-flex items-center gap-2 bg-accent/20 text-accent-foreground rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-semibold text-foreground">Segurança em Primeiro Lugar</span>
            </div>
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Com mais de 500 eventos realizados, a Vivalegria é referência em recreação infantil segura 
              e profissional em São Paulo. Nossa equipe é cuidadosamente selecionada e treinada para 
              garantir a diversão com total segurança.
            </p>
