...
const pricingData: Record<number, { classico: number; select: number }> = {
  ...
  25: { classico: 914.90, select: 1119.90 },
  30: { classico: 1064.90, select: 1269.90 },
  35: { classico: 1189.90, select: 1389.90 },
  40: { classico: 1314.90, select: 1519.90 },
          ...
          <Card className="p-8 md:p-12 shadow-2xl border-2 border-secondary/30">
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="w-20 h-20 rounded-2xl bg-primary flex items-center justify-center">
                  <span className="text-3xl font-bold text-primary-foreground">{children}</span>
                </div>
              </div>
            ...
            <div className="bg-muted rounded-2xl p-6 mb-8">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                  <p className="text-sm text-muted-foreground">Valor do seu evento:</p>
                  <p className="text-4xl font-bold text-primary">
                    R$ {currentPrice.toFixed(2).replace(".", ",")}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {selectedPackage === "select" ? "4 horas + 2 recreadores" : "3 horas + 1 recreador"}
                  </p>
                </div>
                <Button
                  asChild
