...
const blogPosts = [
  {
    ...
    excerpt: "Descubra as atividades mais pedidas e como elas transformam qualquer festa em um momento inesquecível para os pequenos.",
    image: vivaRecreacao,
  ...
  },
  {
    ...
    excerpt: "Entenda a ciência por trás do slime e como essa oficina criativa estimula a coordenação e a criatividade infantil.",
    image: oficinaSlime,
  ...
  },
  {
    ...
    excerpt: "Guia completo para contratar recreação infantil em São Paulo: o que avaliar, preços e dicas importantes.",
