  ...
  const faqs = [
    {
      ...
      answer:
        "O Pacote SELECT para 25 crianças custa R$ 1.119,90, incluindo 4 horas de recreação com 2 recreadores profissionais, pintura facial básica, caça ao tesouro personalizada, escultura de balão, tatuagem infantil e muito mais!",
    },
    {
      question: "Vocês atendem em toda São Paulo e região?",
      answer:
        "Sim! Atendemos toda a Grande São Paulo incluindo Vila Mariana, Moema, Brooklin, Tatuapé, Zona Sul, Zona Oeste, ABC Paulista (Santo André, São Bernardo, São Caetano) e região metropolitana.",
    },
    {
      question: "Qual a antecedência mínima para contratar?",
      answer:
        "Recomendamos agendar com pelo menos 15 dias de antecedência para garantir disponibilidade na data desejada. Para eventos em alta temporada (dezembro e janeiro), sugerimos 30 dias.",
    },
    {
      question: "Vocês levam equipamentos e materiais?",
      answer:
        "Sim! Levamos todos os equipamentos, materiais para oficinas, kit de segurança e higiene. Você só precisa providenciar o espaço.",
    },
    {
      question: "Quantas crianças cada monitor atende?",
      answer:
        "Mantemos a proporção de 1 monitor para cada 15 crianças para garantir segurança e atenção individualizada.",
    },
    {
      question: "Posso personalizar o tema do evento?",
      answer:
        "Com certeza! Trabalhamos com temas personalizados e adaptamos as brincadeiras de acordo com a idade e preferências das crianças.",
    },
    {
      question: "Qual a diferença entre Pacote Select e Clássico?",
      answer:
        "O Pacote SELECT inclui 4 horas de recreação com 2 recreadores, pintura facial e mais atividades. O Pacote CLÁSSICO tem 3 horas com 1 recreador. Ambos são perfeitos, o Select é ideal para festas maiores!",
    },
    {
      question: "Como faço para reservar minha data?",
      answer:
        "É simples! Entre em contato pelo WhatsApp (11) 96598-2251, escolha seu pacote e garanta a data com 50% de sinal via PIX. Emitimos contrato digital e nota fiscal.",
    },
  ];
        ...
        <section className="py-20 bg-muted">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Tire suas dúvidas sobre recreação infantil em São Paulo
              </p>
            </div>
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <p className="text-xl text-primary-foreground/90 leading-relaxed">
                Entre em contato e vamos planejar juntos o evento perfeito para
                você!
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <Button
                  asChild
                  size="lg"
                  className="rounded-full text-lg px-10 h-14 bg-background text-primary hover:bg-background/90"
                >
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="rounded-full text-lg px-10 h-14 border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary"
                >
                  <a
