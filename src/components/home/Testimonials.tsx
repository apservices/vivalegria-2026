...
const testimonials = [
  ...
  },
  {
    ...
    content: "Contratamos para o nosso casamento e foi perfeito! Os convidados curtiram a festa tranquilos sabendo que as crianças estavam se divertindo muito.",
    rating: 5,
  },
  {
    name: "Carlos Eduardo",
    ...
    location: "Tatuapé, SP",
    content: "Já é a terceira festa que fazemos com a Vivalegria. Equipe pontual, organizada e as crianças amam. Não troco por nada!",
    rating: 5,
  },
  {
    name: "Fernanda Lima",
