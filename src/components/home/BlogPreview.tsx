...
const blogPosts = [
  {
    title: "10 Brincadeiras que as CrianÃ§as Amam em Festas de AniversÃ¡rio",
    excerpt: "Descubra as atividades mais pedidas e como elas transformam qualquer festa em um momento inesquecÃ­vel para os pequenos.",
    image: vivaRecreacao,
  ...
  {
    title: "Oficina de Slime: Por Que as CrianÃ§as SÃ£o Obcecadas?",
    excerpt: "Entenda a ciÃªncia por trÃ¡s do slime e como essa oficina criativa estimula a coordenaÃ§Ã£o e a criatividade infantil.",
    image: oficinaSlime,
  ...
  {
    title: "Como Escolher a RecreaÃ§Ã£o Ideal para seu Evento em SP",
    excerpt: "Guia completo para contratar recreaÃ§Ã£o infantil em SÃ£o Paulo: o que avaliar, preÃ§os e dicas importantes.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Dicas e InspiraÃ§Ãµes para sua Festa
          </h2>
          <p className="text-xl text-muted-foreground">
            ConteÃºdos exclusivos para pais e organizadores de eventos
          </p>
        </div>
